...
- [ ] **#72 (remaining)**: SNMP SET (needs a SetCommandResponder + OID resolution; lowest priority) / MQTT command-topic (needs topic+payload design); plus the OPC UA write-fault-gating follow-up
