...
- [ ] **#72 (remaining)**: OPC UA / SNMP / MQTT write detection — each needs its own design (OPC UA read-back/subscription premise; SNMP SET, lowest priority; MQTT command-topic structure)
